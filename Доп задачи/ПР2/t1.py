...
if __name__ == '__main__':
    ...
    # 6
    assert find_str_max_len(
        ["bonus", "python", "task", "practice"]) == "practice"
    print("\nSuccess")
...
random_end = ['ов', 'ев', 'ин', 'ын', 'ский', 'цкий',
              'ской', 'цкой', 'ой', 'ий', 'енков', 'их', 'ых', 'ко']
vowel = ['а', 'я', 'о', 'е', 'у', 'ю', 'ы', 'и', 'э', 'e']
consonant = ['б', 'в', 'г', 'д', 'ж', 'з', 'к', 'л', 'м',
...
if __name__ == '__main__':
    ...
    assert transpose_matrix([[11, 44, 22], [38, 56, 99]]) == [
        [11, 38], [44, 56], [22, 99]]

    # реализация своего print()
    print("func_print()->", "python", [5, 8],
          None, True, sep="\t->\t", end="%\n")
    func_print("func_print()->", "python",
               [5, 8], None, True, sep="\t->\t", end="%\n")
    ...
    assert generate_array([7, 12], [91, 28], [11, 40]) == [
        [7, 12], [91, 28], [11, 40]]
    print("\nSuccess")
